...
void LoadTextures()
{
	...
	pantalla = generateTextures("Texturas/win.jpg", 0);
...
void animate(void)
{
	/*glm::vec3 camara = camera.Position;
	glm::vec3 objeto = glm::vec3 (0.0f, -3.0f, 0.0f);
	if (camara != objeto) {
		flag = true;
	}*/
}
...
void display(Shader shader)
{
	...
	model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -0.001+i));
	shader.setMat4("model", model);
	shader.setVec3("aColor", 1.0f, 1.0f, 1.0f);
